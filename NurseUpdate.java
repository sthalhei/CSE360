...
public class NurseUpdate extends Application implements EventHandler<ActionEvent>{
	...
	public void start(Stage primaryStage) throws Exception {
		...
		TextArea allergiesArea = new TextArea("9/23/2021\n"
		...
		TextArea healthArea = new TextArea("9/23/2021\n"
				  + "Regular wellness check. No precautions. All blood test are good.\n\n"
				  + "6/05/2020\n"
				  + "Joint pain. Please follow prescribed joint soother for 2 months.\n\n");
